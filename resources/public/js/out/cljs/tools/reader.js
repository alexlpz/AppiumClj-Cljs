...
var G__26112 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26112;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26113 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26113,ch);
...
if(("\\" === ch__$1)){
var ch_26114__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26114__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26114__$2);
} else {
}

var G__26115 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26115;
continue;
}
}
...
var vec__26123 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26123,(0),null);
var start_column = cljs.core.nth.call(null,vec__26123,(1),null);
...
var G__26126 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26126;
continue;
}
}
...
var _STAR_read_delim_STAR_26127 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26127;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26128 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26128,(0),null);
var start_column = cljs.core.nth.call(null,vec__26128,(1),null);
...
var vec__26131 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26131,(0),null);
var end_column = cljs.core.nth.call(null,vec__26131,(1),null);
...
var vec__26134 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26134,(0),null);
var start_column = cljs.core.nth.call(null,vec__26134,(1),null);
...
var vec__26137 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26137,(0),null);
var end_column = cljs.core.nth.call(null,vec__26137,(1),null);
...
var vec__26140 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26140,(0),null);
var start_column = cljs.core.nth.call(null,vec__26140,(1),null);
...
var vec__26143 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26143,(0),null);
var end_column = cljs.core.nth.call(null,vec__26143,(1),null);
...
var sb = (function (){var G__26146 = (new goog.string.StringBuffer());
G__26146.append(initch);
...
var G__26148 = (function (){var G__26147 = sb;
G__26147.append(ch);

return G__26147;
})();
var G__26149 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26148;
ch = G__26149;
continue;
}
...
switch (G__26152) {
case "\\":
var G__26156 = (function (){var G__26153 = sb;
G__26153.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26153;
})();
var G__26157 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26156;
ch = G__26157;
continue;
...
break;
default:
var G__26158 = (function (){var G__26154 = sb;
G__26154.append(ch);

return G__26154;
})();
var G__26159 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26158;
ch = G__26159;
continue;
...
var vec__26163 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26163,(0),null);
var column = cljs.core.nth.call(null,vec__26163,(1),null);
...
var vec__26168 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26168,(0),null);
var column = cljs.core.nth.call(null,vec__26168,(1),null);
...
var vec__26173 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26173,(0),null);
var column = cljs.core.nth.call(null,vec__26173,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26178 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26178,(0),null);
var start_column = cljs.core.nth.call(null,vec__26178,(1),null);
...
var vec__26181 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26181,(0),null);
var end_column = cljs.core.nth.call(null,vec__26181,(1),null);
...
var G__26184 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26184,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_26186 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26186;
}});
...
var G__26187 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26187,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26187,rdr,first_line);
...
var G__26191 = matched;
var G__26192 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26191;
finished = G__26192;
continue;
} else {
...
var _STAR_suppress_read_STAR_26193 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26193;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26194 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26195 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26195,"(");
...
var G__26196 = (i + (1));
var G__26197 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26194;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26198 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26198);
...
var G__26199 = cljs.core.next.call(null,s__$1);
var G__26200 = ret;
s__$1 = G__26199;
r = G__26200;
continue;
...
var G__26201 = cljs.core.next.call(null,s);
var G__26202 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26201;
key_vals = G__26202;
continue;
} else {
...
var gensym_env26206 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26206;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26207 = token;
var G__26207__$1 = (((G__26207 == null))?null:cljs.core.subs.call(null,G__26207,(1)));
var G__26207__$2 = (((G__26207__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26207__$1));
var G__26207__$3 = (((G__26207__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26207__$2));
var G__26207__$4 = (((G__26207__$3 == null))?null:cljs.core.symbol.call(null,G__26207__$3));
if((G__26207__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26207__$4);
}
})():(function (){var G__26208 = token;
var G__26208__$1 = (((G__26208 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26208));
if((G__26208__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26208__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e26215){if((e26215 instanceof Error)){
var e = e26215;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26219,reader){
...
var opts = map__26220__$1;
var eof = cljs.core.get.call(null,map__26220__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26226){
...
//# sourceMappingURL=reader.js.map?rel=1523640162422
