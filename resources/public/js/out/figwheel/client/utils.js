...
return (new CustomEvent(event_name,(function (){var obj26558 = {"detail":data};
return obj26558;
})()));
} else {
...
var f = (function (){var pred__26565 = cljs.core._EQ_;
var expr__26566 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26565.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26566))){
return ((function (pred__26565,expr__26566){
return (function (p1__26559_SHARP_){
return console.warn(p1__26559_SHARP_);
});
;})(pred__26565,expr__26566))
} else {
if(cljs.core.truth_(pred__26565.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26566))){
return ((function (pred__26565,expr__26566){
return (function (p1__26560_SHARP_){
return console.debug(p1__26560_SHARP_);
});
;})(pred__26565,expr__26566))
} else {
if(cljs.core.truth_(pred__26565.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26566))){
return ((function (pred__26565,expr__26566){
return (function (p1__26561_SHARP_){
return console.error(p1__26561_SHARP_);
});
;})(pred__26565,expr__26566))
} else {
return ((function (pred__26565,expr__26566){
return (function (p1__26562_SHARP_){
return console.log(p1__26562_SHARP_);
});
;})(pred__26565,expr__26566))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26569){
...
var eval_fn = cljs.core.get.call(null,map__26570__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26572_SHARP_);
});})(new_def))
);
...
return (function (p__26573){
var vec__26574 = p__26573;
var ky = cljs.core.nth.call(null,vec__26574,(0),null);
var v = cljs.core.nth.call(null,vec__26574,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1523640163025
